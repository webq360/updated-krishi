...
const JWT_SECRET = process.env.JWT_SECRET || 'krishi-bondhu-jwt-secret-key-2026';
...
async function connectMongoDB() {
  ...
  try {
    ...
    // If Atlas fails and we are in local dev, fallback to localhost
...
// URL Normalization Middleware: guarantees all internal URLs start with /api
...
// Middleware to ensure DB connection on all requests
